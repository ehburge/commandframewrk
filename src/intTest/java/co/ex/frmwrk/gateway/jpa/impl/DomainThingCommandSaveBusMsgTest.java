...
public class DomainThingCommandSaveBusMsgTest {
  ...
  public void testCreateThingCommand() {
    ...
    AppThingCommandSave appThingCommandSave1 =
        AppThingCommandSave.builder()
            ...
            .build();
    AppThingCommandSave createThingCommand2 =
        AppThingCommandSave.builder()
            .thingNbr(234L)
            .description("desc")
            ...
            .build();
    AppThingCommandSave createThingCommand3 =
        AppThingCommandSave.builder()
            .thingNbr(345L)
            .description("desc")
            .fullDescription("fullDesc")
            ...
            .build();
    AppThingCommandSave createThingCommand4 =
        AppThingCommandSave.builder()
            .thingNbr(456L)
            .description("desc")
            .fullDescription("fullDesc")
